...
typedef NS_ENUM(NSUInteger, ACSAMKeychainQuerySynchronizationMode) {
 ...
 */
@interface ACSAMKeychainQuery : NSObject
...
@property (nonatomic) ACSAMKeychainQuerySynchronizationMode synchronizationMode;
#endif
