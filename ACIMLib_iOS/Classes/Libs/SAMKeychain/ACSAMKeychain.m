...
#import "ACSAMKeychainQuery.h"

NSString *const kACSAMKeychainErrorDomain = @"com.samsoffes.samkeychain";
NSString *const kACSAMKeychainAccountKey = @"acct";
NSString *const kACSAMKeychainCreatedAtKey = @"cdat";
NSString *const kACSAMKeychainClassKey = @"labl";
NSString *const kACSAMKeychainDescriptionKey = @"desc";
NSString *const kACSAMKeychainLabelKey = @"labl";
NSString *const kACSAMKeychainLastModifiedKey = @"mdat";
NSString *const kACSAMKeychainWhereKey = @"svce";

#if __IPHONE_4_0 && TARGET_OS_IPHONE
	static CFTypeRef SAMKeychainAccessibilityType = NULL;
#endif

@implementation ACSAMKeychain
...
+ (nullable NSString *)passwordForService:(NSString *)serviceName account:(NSString *)account error:(NSError *__autoreleasing *)error {
	ACSAMKeychainQuery *query = [[ACSAMKeychainQuery alloc] init];
