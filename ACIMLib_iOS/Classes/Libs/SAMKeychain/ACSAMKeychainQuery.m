...
@implementation ACSAMKeychainQuery
...
- (BOOL)save:(NSError *__autoreleasing *)error {
	...
	if (status == errSecSuccess) {//item already exists, update it!
		...
		CFTypeRef accessibilityType = [ACSAMKeychain accessibilityType];
...
+ (NSError *)errorWithCode:(OSStatus) code {
	...
	return [NSError errorWithDomain:kACSAMKeychainErrorDomain code:code userInfo:nil];
}
