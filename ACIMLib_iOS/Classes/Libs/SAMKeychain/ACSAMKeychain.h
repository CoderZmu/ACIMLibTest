...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, ACSAMKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	SAMKeychainErrorBadArguments = -1001,
};

/** SAMKeychain error domain */
extern NSString *const kACSAMKeychainErrorDomain;

/** Account name. */
extern NSString *const kACSAMKeychainAccountKey;
 ...
 */
extern NSString *const kACSAMKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kACSAMKeychainClassKey;

/** Item description. */
extern NSString *const kACSAMKeychainDescriptionKey;

/** Item label. */
extern NSString *const kACSAMKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kACSAMKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kACSAMKeychainWhereKey;
 ...
 */
@interface ACSAMKeychain : NSObject
