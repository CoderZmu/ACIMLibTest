...
@class ACAsyncReadPacket;
@class ACAsyncWritePacket;
@class ACGCDAsyncSocketPreBuffer;
@protocol ACGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const ACGCDAsyncSocketException;
extern NSString *const ACGCDAsyncSocketErrorDomain;

extern NSString *const ACGCDAsyncSocketQueueName;
extern NSString *const ACGCDAsyncSocketThreadName;

extern NSString *const ACGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const ACGCDAsyncSocketUseCFStreamForTLS;
#endif
#define ACGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define ACGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define ACGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const ACGCDAsyncSocketSSLPeerID;
extern NSString *const ACGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const ACGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const ACGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const ACGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const ACGCDAsyncSocketSSLCipherSuites;
extern NSString *const ACGCDAsyncSocketSSLALPN;
#if !TARGET_OS_IPHONE
extern NSString *const ACGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define ACGCDAsyncSocketLoggingContext 65535


typedef NS_ERROR_ENUM(ACGCDAsyncSocketErrorDomain, ACGCDAsyncSocketError) {
	ACGCDAsyncSocketNoError = 0,           // Never used
	ACGCDAsyncSocketBadConfigError,        // Invalid configuration
	ACGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	ACGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	ACGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	ACGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	ACGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	ACGCDAsyncSocketClosedError,           // The remote peer closed the connection
	ACGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface ACGCDAsyncSocket : NSObject

/**
 * ACGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, ACGCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<ACGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<ACGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

/**
 * Create ACGCDAsyncSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<ACGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<ACGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<ACGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<ACGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<ACGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<ACGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means ACGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means ACGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, ACGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, ACGCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of ACGCDAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a ACGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a ACGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that ACGCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - ACGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So ACGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - ACGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default ACGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct ACGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, ACGCDAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by ACGCDAsyncSocket,
 ...
 *
 * - ACGCDAsyncSocketSSLProtocolVersionMin
 * - ACGCDAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - ACGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - ACGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - ACGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - ACGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see ACGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use ACGCDAsyncSocketSSLProtocolVersionMin & ACGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * ACGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(ACGCDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(ACGCDAsyncSocket *)sock didAcceptNewSocket:(ACGCDAsyncSocket *)newSocket
 * {
 ...
 * Example usage:
 * 
 * - (void)socket:(ACGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol ACGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(ACGCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(ACGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(ACGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(ACGCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used for things such as updating progress bars.
**/
- (void)socket:(ACGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(ACGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(ACGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(ACGCDAsyncSocket *)sock;
 ...
 * 
 * Note: If the ACGCDAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(ACGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socket:(ACGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
