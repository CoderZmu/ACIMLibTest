...
@interface ACFMResultSet () {
    NSMutableDictionary *_columnNameToIndexMap;
}
@end

@implementation ACFMResultSet

+ (instancetype)resultSetWithStatement:(ACFMStatement *)statement usingParentDatabase:(ACFMDatabase*)aDB {
    
    ACFMResultSet *rs = [[ACFMResultSet alloc] init];
    ...
    return ACFMDBReturnAutoreleased(rs);
}
...
- (void)dealloc {
    ...
    ACFMDBRelease(_columnNameToIndexMap);
...
- (NSDictionary *)resultDict {
    ...
    if (num_cols > 0) {
        ...
        return ACFMDBReturnAutoreleased([dict copy]);
    }
    else {
