...
@interface ACFMDatabasePool : NSObject
...
- (BOOL)databasePool:(ACFMDatabasePool*)pool shouldAddDatabaseToPool:(ACFMDatabase*)database;
...
- (void)databasePool:(ACFMDatabasePool*)pool didAddDatabase:(ACFMDatabase*)database;
