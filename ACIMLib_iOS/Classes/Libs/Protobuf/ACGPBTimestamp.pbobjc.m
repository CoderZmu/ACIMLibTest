...
#pragma mark - ACGPBTimestampRoot

@implementation ACGPBTimestampRoot
...
#pragma mark - ACGPBTimestampRoot_FileDescriptor

static ACGPBFileDescriptor *ACGPBTimestampRoot_FileDescriptor(void) {
...
@implementation ACGPBTimestamp

@dynamic seconds;
@dynamic nanos;

typedef struct ACGPBTimestamp__storage_ {
  uint32_t _has_storage_[1];
  int32_t nanos;
  int64_t seconds;
} ACGPBTimestamp__storage_;
    ...
    static ACGPBMessageFieldDescription fields[] = {
      {
        ...
        .number = ACGPBTimestamp_FieldNumber_Seconds,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(ACGPBTimestamp__storage_, seconds),
      ...
      },
      {
        .name = "nanos",
        .dataTypeSpecific.clazz = Nil,
        .number = ACGPBTimestamp_FieldNumber_Nanos,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(ACGPBTimestamp__storage_, nanos),
        .flags = (ACGPBFieldFlags)(ACGPBFieldOptional | ACGPBFieldClearHasIvarOnZero),
        .dataType = ACGPBDataTypeInt32,
      },
    };
    ACGPBDescriptor *localDescriptor =
        [ACGPBDescriptor allocDescriptorForClass:[ACGPBTimestamp class]
                                     rootClass:[ACGPBTimestampRoot class]
                                          file:ACGPBTimestampRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(ACGPBMessageFieldDescription))
                                   storageSize:sizeof(ACGPBTimestamp__storage_)
