...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `ACSDImageCoderHelper`.
 @note If you need to specify animated images loop count, use `acsd_imageLoopCount` property in `UIImage+Metadata.h`.
 */
@interface ACSDImageFrame : NSObject
