...
/**
 ...
 Coders
 ------
 A coder must conform to the `ACSDImageCoder` protocol or even to `SDProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface ACSDImageCodersManager : NSObject <ACSDImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) ACSDImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<ACSDImageCoder>> *coders;
