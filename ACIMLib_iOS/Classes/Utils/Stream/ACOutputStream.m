...
- (void)writeInt8:(int8_t)value
{
    ...
    [_wrappedOutputStream write:(const uint8_t *)&value maxLength:1];
...
- (void)writeInt16:(int16_t)value
{
    ...
    [_wrappedOutputStream write:(const uint8_t *)&value maxLength:2];
